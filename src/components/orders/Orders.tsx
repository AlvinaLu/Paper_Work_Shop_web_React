...
import {Avatar, Button, CircularProgress, Container, Grid, makeStyles, Paper, Typography} from "@material-ui/core";
    ...
    myOrders(user)
      .then(result => {
        if (result.status == 200) {
          ...
          console.log("Orders request is wrong" + result.errorText);
